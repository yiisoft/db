...
use Yiisoft\Db\Expressions\ExpressionBuilder;
use Yiisoft\Db\Expressions\ExpressionBuilderInterface;
use Yiisoft\Db\Expressions\ExpressionInterface;
use Yiisoft\Db\Querys\Conditions\HashCondition;
use Yiisoft\Db\Querys\Conditions\SimpleCondition;
...
class QueryBuilder
{
     ...
     * of {@see \Yiisoft\Db\Querys\Query|Query} to perform INSERT INTO ... SELECT SQL statement. Passing of
     * {@see \Yiisoft\Db\Querys\Query|Query}.
     ...
     * @param string $table the table that new rows will be inserted into.
     * @param array|Query $columns the column data (name => value) to be inserted into the table or instance
     * of {\Yiisoft\Db\Querys\Query|Query} to perform INSERT INTO ... SELECT SQL statement.
    ...
    {
        if (!\is_array($columns->select) || empty($columns->select) || \in_array('*', $columns->select, true)) {
