...
abstract class AbstractDMLQueryBuilder implements DMLQueryBuilderInterface
{
     ...
     *
     * @param mixed $row The rows to be batch inserted into the table.
     * @param string[] $columnNames The column names.
     * @param array $keys The column names.
     * @param string[] $names The column names.
     * @param array|ColumnInterface[] $columns The table columns.
     * @param array $currentStatementParams The binding parameters that will be generated by this method.
     *
