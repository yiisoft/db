...
abstract class AbstractDQLQueryBuilder implements DQLQueryBuilderInterface
{
    ...
    protected function defaultExpressionBuilders(): array
    {
        return [
            ...
            Condition\BetweenCondition::class => Condition\BetweenConditionBuilder::class,
            Condition\InCondition::class => Condition\InConditionBuilder::class,
            Condition\LikeCondition::class => Condition\LikeConditionBuilder::class,
            Condition\ExistsCondition::class => Condition\ExistsConditionBuilder::class,
            SimpleCondition::class => Condition\SimpleConditionBuilder::class,
            HashCondition::class => Condition\HashConditionBuilder::class,
            Condition\BetweenColumnsCondition::class => Condition\BetweenColumnsConditionBuilder::class,
