...
abstract class AbstractDQLQueryBuilder implements DQLQueryBuilderInterface
{
    ...
    protected function defaultConditionClasses(): array
    {
        return [
            ...
            'ILIKE' => Condition\LikeCondition::class,
            'NOT ILIKE' => Condition\LikeCondition::class,
            'OR ILIKE' => Condition\LikeCondition::class,
            'OR NOT ILIKE' => Condition\LikeCondition::class,
