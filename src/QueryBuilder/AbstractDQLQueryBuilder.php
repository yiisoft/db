...
abstract class AbstractDQLQueryBuilder implements DQLQueryBuilderInterface
{
    ...
    protected function defaultExpressionBuilders(): array
    {
        return [
            ...
            Expression::class => ExpressionBuilder::class,
            Condition\NotCondition::class => Condition\NotConditionBuilder::class,
            ...
            Condition\BetweenCondition::class => Yiisoft\Db\QueryBuilder\Condition\BetweenConditionBuilder::class,
            Condition\InCondition::class => Yiisoft\Db\QueryBuilder\Condition\InConditionBuilder::class,
            Condition\LikeCondition::class => Yiisoft\Db\QueryBuilder\Condition\LikeConditionBuilder::class,
            Condition\ExistsCondition::class => Yiisoft\Db\QueryBuilder\Condition\ExistsConditionBuilder::class,
            SimpleCondition::class => Condition\SimpleConditionBuilder::class,
            HashCondition::class => Yiisoft\Db\QueryBuilder\Condition\HashConditionBuilder::class,
            Condition\BetweenColumnsCondition::class => Yiisoft\Db\QueryBuilder\Condition\BetweenColumnsConditionBuilder::class,
