...
/**
 * The IndexConstraint represents a constraint on a database index, such as a primary key or unique
 * constraint. The class allows working with index constraints: checking if a
