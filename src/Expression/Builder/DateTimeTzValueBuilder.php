...
/**
 * Builder for {@see DateTimeTzValue} expressions.
 *
 * @implements ExpressionBuilderInterface<DateTimeTzValue>
 */
final class DateTimeTzValueBuilder implements ExpressionBuilderInterface
{
    /**
    ...
    {
        $format = $this->hasMicroseconds($expression->value) ? 'Y-m-d H:i:s.uP' : 'Y-m-d H:i:sP';
