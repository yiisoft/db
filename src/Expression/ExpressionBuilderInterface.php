...
/**
 * The ExpressionBuilderInterface defines the methods to build database expressions, such as conditions for a SELECT statement or values to be inserted into a
 * table. These methods include creating comparison operators (e.g. "=", ">", "<"), combining expressions
