 ...
 * {@see createTable()} method can be used to create a database table. Compared with the same methods in {@see Command},
 * these methods will display extra information showing the method parameters and execution time, which may be useful
...
class Migration implements MigrationInterface
{
    ...
    {
        echo 'Exceptions: ' . $e->getMessage() . ' (' . $e->getFile() . ':' . $e->getLine() . ")\n";
     ...
     *
     * This method executes the specified SQL statement using {@see db}.
     *
    ...
    /**
     * Creates and executes a command to insert rows into a database table if they do not already exist
     * (matching unique constraints), or update them if they do.
     *
     * The method will properly escape the column names, and bind the values to be inserted.
     *
     ...
     *
     * The {@see QueryBuilder::getColumnType()} method will be invoked to convert any abstract type into a physical one.
     *
     ...
     * @param string $type   the column type. The {@see QueryBuilder::getColumnType()} method will be invoked to convert
     * abstract column type (if any) into the physical one. Anything that is not recognized as abstract type will be
     * kept in the generated SQL.
     *
     ...
     * @param string $type the new column type. The {@see QueryBuilder::getColumnType()} method will be invoked to
