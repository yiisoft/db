...
class SqlToken implements \ArrayAccess
{
     ...
     *
     * @param int $type token type. It has to be one of the following constants:
     */
     ...
     *
     * @param int $startOffset original SQL token start position.
     */
     ...
     *
     * @param int $endOffset original SQL token end position.
     */
     ...
     * Set parent token.
     *
     * @param SqlToken $parent parent token.
     */
    public function setParent(SqlToken $parent): void
    {
        $this->parent = $parent;
    }
}
