...
class Query extends Database implements QueryInterface, ExpressionInterface
{
    ...
    /**
     * @var \Yiisoft\Cache\Dependencies\Dependency the dependency to be associated with the cached query result for this
     * query
     *
     * {@see cache()}
     */
...
PATTERN;
     ...
     * based on filter values entered by users.
     *
     * @param array $condition the new HAVING condition. Please refer to {@see having()} on how to specify this parameter.
     *
     * @return $this the query object itself
     *
     * {@see filterHaving()}
