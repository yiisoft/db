...
class Command
{
    ...
    {
        [$profile, $rawSql] = $this->logQuery('\Yiisoft\Db\Commands\Command::query');
            ...
            if (\is_array($info)) {
                ...
                if (\is_array($result) && isset($result[0])) {
                    $this->logger->log(
                        ...
                        ['\Yiisoft\Db\Commands\Command::query']
                    );
        ...
        try {
            $this->profiler->begin((string) $rawSql, ['\Yiisoft\Db\Commands\Command::query']);
            ...
            $this->profiler->end((string) $rawSql, ['\Yiisoft\Db\Commands\Command::query']);
        } catch (Exception $e) {
            $this->profiler->end((string) $rawSql, ['\Yiisoft\Db\Commands\Command::query']);
