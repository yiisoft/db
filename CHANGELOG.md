...
- Chg #1000, #1007, #1027: Add compare conditions: `Equals`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan` and
 `LessThanOrEqual`. Remove `Hash` condition in favor `Equals` and `In` usage (@vjik)
