...
use Yiisoft\Db\Tests\Provider\QueryProvider;
...
abstract class CommonQueryTest extends IntegrationTestCase
{
    ...
    #[DataProviderExternal(QueryProvider::class, 'normalizeOrderBy')]
    ...
    #[DataProviderExternal(QueryProvider::class, 'normalizeSelect')]
