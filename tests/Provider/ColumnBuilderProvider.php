...
class ColumnBuilderProvider
{
    ...
    public static function buildingMethods(): array
    {
        return [
            ...
            ['money', [], StringColumnSchema::class, ColumnType::MONEY, ['getSize' => 19, 'getScale' => 4]],
            ['money', [8], StringColumnSchema::class, ColumnType::MONEY, ['getSize' => 8, 'getScale' => 4]],
            ['money', [8, 2], StringColumnSchema::class, ColumnType::MONEY, ['getSize' => 8, 'getScale' => 2]],
